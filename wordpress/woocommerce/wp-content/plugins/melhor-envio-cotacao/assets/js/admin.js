...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Pedido_Acoes_vue__ = __webpack_require__(85);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Pedido_Informacoes_vue__ = __webpack_require__(87);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_shipping_services__ = __webpack_require__(83);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: _extends({}, Object(__WEBPACK_IMPORTED_MODULE_0_vuex__["mapActions"])("configuration", ["getConfigs", "setLoader", "setAgenciesAzul", "setAgencies", "saveAll", "getEnvironment"]), {
    ...
    showAzulAgencies(data) {
      ...
      var responseAgencies = [];
      var promiseAgencies = new Promise((resolve, reject) => {
        this.$http.post(`${ajaxurl}?action=get_agency_azul&city=${data.city}&state=${data.state}`).then(function (response) {
          if (response && response.status === 200) {
            responseAgencies = response.data.agencies;
            resolve(true);
          }
...
var _adminMenuFix = __webpack_require__(102);
...
var _Configuracoes = __webpack_require__(91);

var _Configuracoes2 = _interopRequireDefault(_Configuracoes);

var _Token = __webpack_require__(95);

var _Token2 = _interopRequireDefault(_Token);

var _Log = __webpack_require__(98);
...
/* empty harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_05a7e32e_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Pedidos_vue__ = __webpack_require__(90);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_d2a4016e_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Documentos_vue__ = __webpack_require__(84);
var disposed = false
var normalizeComponent = __webpack_require__(0)
/* script */
...
exports.default = {
    ...
    VIA_BRASIL_AERO: VIA_BRASIL_AERO,
            ...
            _c(
              ...
              [
                ...
                ((_vm.item.quotation.choose_method ==
                  ...
                  _vm.item.quotation.choose_method == _vm.services.JADLOG_COM ||
                  _vm.item.quotation.choose_method ==
                    _vm.services.JADLOG_LATAM) &&
                  !_vm.item.non_commercial) ||
                _vm.item.quotation.choose_method ==
                  _vm.services.VIA_BRASIL_AERO ||
                _vm.item.quotation.choose_method ==
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_462ea3e1_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Acoes_vue__ = __webpack_require__(86);
var disposed = false
var normalizeComponent = __webpack_require__(0)
/* script */
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_760ccfd0_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Informacoes_vue__ = __webpack_require__(89);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
/* empty harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_260cb748_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Configuracoes_vue__ = __webpack_require__(94);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
    ...
    [
                    ...
                    _c("input", {
                      ...
                      on: {
                        change: [
                          ...
                          function($event) {
                            return _vm.showJadlogAgenciesState()
                          }
                        ]
                      }
                    }),
      ...
      _c(
          ...
          directives: [
            {
              name: "show",
              rawName: "v-show",
              value: _vm.token_environment == "production",
              expression: "token_environment == 'production'"
            }
          ],
        ...
        [
          ...
          _c("p", [
            _vm._v(
              "Escolha a agência Azul Cargo Express de sua preferência para realizar o envio dos seus produtos."
            )
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "wpme_flex" }, [
                  ...
                  [
                    _c(
                      "select",
                      {
                        ...
                        attrs: { name: "agenciesAzul", id: "agenciesAzul" },
                        on: {
                          change: function($event) {
                            var $$selectedVal = Array.prototype.filter
                              .call($event.target.options, function(o) {
...
/* empty harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_1bf58fd9_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Token_vue__ = __webpack_require__(97);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
/* empty harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_ed77a4b8_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Log_vue__ = __webpack_require__(101);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var _orders = __webpack_require__(104);

var _orders2 = _interopRequireDefault(_orders);

var _balance = __webpack_require__(105);

var _balance2 = _interopRequireDefault(_balance);

var _configuration = __webpack_require__(106);
...
var configuration = {
    ...
    actions: {
        ...
        getAllAgencies: function getAllAgencies(_ref4, data) {
            var commit = _ref4.commit;
        ...
        saveAll: function saveAll(_ref5, data) {
            var commit = _ref5.commit;
        ...
        setLoader: function setLoader(_ref6, data) {
            var commit = _ref6.commit;

            commit('toggleLoader', data);
        },
        setAgencies: function setAgencies(_ref7, data) {
            var commit = _ref7.commit;

            commit('setAgency', data);
        },
        setAgenciesAzul: function setAgenciesAzul(_ref8, data) {
            var commit = _ref8.commit;

            commit('setAgencyAzul', data);
        },
        setAllAgencies: function setAllAgencies(_ref9, data) {
            var commit = _ref9.commit;
